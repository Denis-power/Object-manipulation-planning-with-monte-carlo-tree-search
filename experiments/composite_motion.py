...
from cto.exp import exp_composite
...
for n_desired_poses in range(1, 4):
    results = exp_composite('sc', n_desired_poses, 
                            object_urdf, robot_config, trained_networks,
                            n_trials=50, mcts_iter=100, include_miqp=False)
    print('________________________________')
    print('results for ', n_desired_poses, 'desired poses.')

...
def exp_primitive(primitive, object_urdf, robot_config, trained_networks,
    ...
    if save_results:
        import pickle
        with open('D:/Denis/Programs/PyCharm Community Edition 2021.2.3/Manipulation_Monte_Karlo2/contact_mcts/src/cto/logs/primitive_' + primitive +'.pkl', 'wb') as f:
...
def exp_composite(primitive, n_desired_poses, 
    ...
    if save_results:
        import pickle
        with open('D:/Denis/Programs/PyCharm Community Edition 2021.2.3/Manipulation_Monte_Karlo2/contact_mcts/src/cto/logs/composite_' + primitive +'.pkl', 'wb') as f:
            pickle.dump(results, f)
